...
os.environ['NEOS_EMAIL'] = 'dkent287@gmail.com'
...
#--------------------------------------------------------------------------------------------------------------
### Step 2: Initiatize Model and Specify Decision Variables ###################################################
#--------------------------------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------------------------------
### Step 3: Specify Objective Function #########################################################################
#---------------------------------------------------------------------------------------------------------------
...
def get_work_table(works):
    ...
    week_table['aMon'] = week_table.pop('Mon')
    week_table['bTue'] = week_table.pop('Tue')
    week_table['cWed'] = week_table.pop('Wed')
    week_table['dThu'] = week_table.pop('Thu')
    week_table['eFri'] = week_table.pop('Fri')
    week_table['fSat'] = week_table.pop('Sat')
